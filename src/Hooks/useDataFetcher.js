...
export default ({
  ...
  return !!skip ? {} : { objects: items, nextToken, loading: !!fetchAll ? !!nextToken || !!loading : loading, error, nextToken, refetch, handleRefresh, handleEndReached, clearResults, /* onUpdateLoading, onCreateLoading,*/  }
